...
我是一名国外商学院毕业的留学生，完全不懂代码。我在上海一家船舶建造 EPC 公司协助处理船检文件，对 AI 的兴趣让我尝试把智能体嵌入日常重复工作。我观察到公司仓库管理系统十分老旧——仓库管理员曹姐还在填纸质表格、配合 Excel 统计数据；船舶配件数量繁多、型号复杂，她经常加班核对却依然容易出错。看到这些痛点，我使用 AI 编程工具（Qoder + 通义千问）手搓了这套智能库存管理系统，全部功能由 AI 编程完成，并已在公司真实上线使用。
